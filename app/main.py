...
trainer=TrainingManager(shadow,version="v0.11.3")
...
def model_available(symbol,version="v0.11.3"):
...
def live_status():
    ...
    for symbol in ("XAUUSD","BTCUSD"):
        ...
        model_status[symbol]={
            ...
            "version":"v0.11.3" if path.exists() else None,
...
<title>AI Market Intelligence V0.11.3</title>
<style>
...
<div class="wrap">
  <div class="top">
    <div><h1>AI Market Intelligence Agent V0.11.3</h1><div class="sub">XAUUSD: MT5 · BTCUSD: Coinbase BTC-USD · SMC · ML inference · Shadow journal</div></div>
  ...
  <div class="grid">
    ...
    <div class="card span4"><div class="k">XAUUSD ML Model</div><div class="v" id="xauModel">—</div><div class="small">Separate BUY/SELL models with auto calibration and temporal stability gating.</div></div>
    <div class="card span4"><div class="k">BTCUSD ML Model</div><div class="v" id="btcModel">—</div><div class="small">90-day Coinbase training, walk-forward stability, side models and contextual thresholds.</div></div>
    ...
    <div class="card span12" id="btcTrainingCard">
      <div class="train-head">
        <div>
          ...
          <div class="train-title">Coinbase History → Walk-Forward Stability → BUY/SELL Models → Calibration → Context Policy → Quality Gate</div>
      ...
      <div class="train-steps">
        ...
        <div class="train-step" id="step5" data-num="6"><div class="train-flow"></div><div class="step-no">6</div><div class="step-name">READY v0.11.3</div><div class="step-desc">Validated artifact available for shadow inference.</div></div>
      </div>
      ...
      <div class="ready-burst" id="readyBurst">
        ...
        <div><b>BTCUSD V0.11.3 training artifact is READY.</b><div class="small">Shadow signals remain blocked unless the independent quality gate passes.</div></div>
      </div>
    </div>
  ...
  <div class="footer">V0.11.3 research mode. BTCUSD is sourced from Coinbase BTC-USD. M3 is built causally from three closed 1-minute Coinbase candles. Broker orders remain disabled.</div>
</div>
<script>
...
function drawTrainingState(status, meta={}, visualOnly=false){
  ...
  if(!visualOnly){
    $("trainVersion").textContent=meta.version||"v0.11.3";
